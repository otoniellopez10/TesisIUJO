...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2021 a las 12:59:02
...
(1, 'Fernando Trías De Bes Mingot', 1),
(2, 'Álex Rovira Celma', 1),
(3, 'Jorge Saenz', 1);
...
--
-- Volcado de datos para la tabla `bitacora_libro`
--

INSERT INTO `bitacora_libro` (`id`, `usuario_id`, `libro_id`, `operacion`, `fecha`) VALUES
(1, 1, 1, 'Se ha registrado el libro titulado: La Buena Suerte', '2021-07-02 04:07:23'),
(2, 1, 2, 'Se ha registrado el libro titulado: Calculo diferencial', '2021-07-02 10:40:14');
...
(1, 'La Buena Suerte', 27, 'Primera edición', '2004-01-01', 10, 9, 'Para Guillermo Trías, mi padre, con todo mi amor y agradecimiento, pues él me \r\nenseñó las reglas de la Buena Suerte sin relatarme ninguna fábula. \r\nEl fue quien me hizo ver que, esencialmente, es una cuestión de fe, generosidad y Amor, con \r\nmayúsculas', 'U6FlY2dewQnSOMKg7DJPLa Buena Suerte - Alex Rovira.pdf', 1),
(2, 'Calculo diferencial', 28, 'Segunda edición', '2005-01-01', 10, 6, 'Esta segunda edición aparece diez años después que se publicó la primera. Es muy gratificante la acogida que ha tenido la primera edición ', 'wcLgnkM4uXFoHDvElryIpdfcookie.com_calculo-diferencial.pdf', 1);
